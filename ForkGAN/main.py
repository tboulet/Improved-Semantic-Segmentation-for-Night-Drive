...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./check', help='models are saved here')
parser.add_argument('--checkpoint_path', dest='checkpoint_path', help='model to use')
